...
class screen(AVGApp):
    def __init__(self, parentNode):
        ...
        def right():
            ...
            #ON Message
        def hallo(string,null):
            
            array = string.split("###")
                         
            neueLeute = []
            neueLeute.append([array[0], array[1]])
            neueLeute.append([array[2], array[3]])
            neueLeute.append([array[4], array[5]])
        ...
        left()
        right()
        string = ("Norine###460###Stefanie###210###Kirstin###60")
        thread.start_new_thread(hallo,(string,0))
