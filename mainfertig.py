...
class screen(AVGApp):
    def __init__(self, parentNode):
        ...
        #Wert für die maximale Animationsdauer des Rankings, sodass die einzelnen Aenderungen animiert werden (in Sekunden)
        ...
        def left():
            ...
            #Initialisierung der sieben Divs fuer die Plaetze mit ihren zugehöhrigen Wordsnodes 
